              ...
              <ul class="participants-list" style="list-style-type: none; margin-left: 0; padding-left: 0;">
                ${details.participants.map(email => `
                  <li style="display: flex; align-items: center; gap: 6px;">
                    <span>${email}</span>
                    <span class="delete-participant" title="Remove participant" data-activity="${name}" data-email="${email}" style="cursor:pointer;color:#c62828;font-size:18px;user-select:none;">&#10006;</span>
                  </li>
                `).join("")}
              </ul>
            </div>
